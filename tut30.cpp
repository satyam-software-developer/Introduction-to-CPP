...
The main things to note here are that constructors are written in the public section of
...
2nd parameterized constructor of the “point” class is defined which takes
two parameters and assigns the values to the private data members of the class.
