...
When a static data member is created, there is only a single copy of 
the data member which is shared between all the objects of the class. 
As we have discussed in our previous lecture that if the data members are not static 
...
As shown in Code Snippet 1, we created an employee class 
that has integer “id” variable and “count” static integer variable as private class members; 
and “setData” void function, “getData” void function, and “getCount” static void function as public class members. 
These functions are explained below.

We have defined a “setData” function. This function will take input for “id” from the user at runtime and increment in the count. 
...
We have defined a static “getCount” function. This function will print the value of the variable count”. 
The main thing to note here is that “getCount” function is static, 
...
The functions “setData”, “getData” are called by the object “harry”, 
...
As shown in figures 1 and 2, for the “harry” object we entered the ID “1”; 
for the “rohan” object we entered the ID “2”; and for the “lovish” object 
we entered the ID “3”. The Output of the program has displayed the ID and the count of each employee. */
